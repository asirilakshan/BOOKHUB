...
$sql = "SELECT c.id, u.fullname, b.title, c.quantity, (b.price * c.quantity) as total 
        FROM cart c 
...
<section style="padding: 60px 8%;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <div style="margin-bottom: 40px;">
            <h1 style="font-size: 36px; color: #333;">📦 Orders</h1>
        </div>
                ...
                <tbody>
                    ...
                    if($result && $result->num_rows > 0){
                        while($row = $result->fetch_assoc()){
                            ...
                            echo "<td style='text-align: right; color: #667eea; font-weight: 600;'>\$" . htmlspecialchars(number_format($row['total'], 2)) . "</td>";
                            echo "<td style='text-align: center;'>";
                            echo "<form method='POST' action='delete_order.php' style='display:inline;'>";
                        ...
                        echo "<tr><td colspan='6' style='text-align: center; padding: 30px;'>📭 No orders found</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
